...
class FasterRCNNOBBRGBDDDDepthDA(BaseDetector):
    ...
    def __init__(self,
        ...
        super(FasterRCNNOBBRGBDDDDepthDA, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(FasterRCNNOBBRGBDDDDepthDA, self).init_weights(pretrained)
    ...
    def forward(self, rgb, img_metas, depth=None, origin_depth=None, segment=None, return_loss=True, **kwargs):
