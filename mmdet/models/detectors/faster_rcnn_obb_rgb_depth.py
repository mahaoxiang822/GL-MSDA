...
class FasterRCNNOBBRGBDepth(TwoStageOBBDetector):
    ...
    def __init__(self,
                 ...
                 neck=None,
                 pretrained=None):
        super(FasterRCNNOBBRGBDepth, self).__init__(
    ...
    def simple_test(self, rgb, img_metas,
                    gt_rect_grasps=None,
                    gt_scores=None,
                    depth=None,
                    origin_depth=None,
        ...
        results = self.roi_head.simple_test(x, origin_depth, proposal_list, img_metas, dataset=dataset, rescale=rescale)
