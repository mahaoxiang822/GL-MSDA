...
from mmdet.core import (multi_apply, hbbox_to_xywhtheta, xywhtheta_to_rect_grasp_group, xywhtheta_to_points_graspnet,
                        multiclass_poly_nms_8_points, points_to_xywhtheta_graspnet,
                        build_bbox_coder)
from mmdet.models.utils import ModelFreeCollisionDetector

@HEADS.register_module
class BBoxHeadGraspNetSinCos(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_classes=80,
                 bbox_coder=dict(
                     type='DeltaXYWHSinCosGraspCoder',
                     target_means=[0., 0., 0., 0., 0., 0.],
                     target_stds=[0.1, 0.1, 0.2, 0.2, 1., 1.]),
                 ...
                 loss_grasp=dict(
                     type='SmoothL1Loss', beta=1.0, loss_weight=1.0)                 ):
        super(BBoxHeadGraspNetSinCos, self).__init__()
        ...
        # dx, dy, dw, dh, sin(2dtheta), cos(2dtheta), 6 dims
